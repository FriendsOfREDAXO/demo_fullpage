...
INSERT INTO `rex_config` VALUES 
  ...
  (348,'demo_fullpage','showslidearrows','\"1\"'),
  (381,'core','package-config','{\"backup\":{\"install\":true,\"status\":true},\"be_style\":{\"install\":true,\"status\":true,\"plugins\":{\"customizer\":{\"install\":true,\"status\":false},\"redaxo\":{\"install\":true,\"status\":true}}},\"cronjob\":{\"install\":false,\"status\":false,\"plugins\":{\"article_status\":{\"install\":false,\"status\":false},\"optimize_tables\":{\"install\":false,\"status\":false}}},\"demo_fullpage\":{\"install\":true,\"status\":true},\"install\":{\"install\":true,\"status\":true},\"media_manager\":{\"install\":true,\"status\":true},\"mediapool\":{\"install\":true,\"status\":true},\"metainfo\":{\"install\":true,\"status\":true},\"phpmailer\":{\"install\":true,\"status\":true},\"project\":{\"install\":true,\"status\":true},\"structure\":{\"install\":true,\"status\":true,\"plugins\":{\"content\":{\"install\":true,\"status\":true},\"history\":{\"install\":false,\"status\":false},\"version\":{\"install\":false,\"status\":false}}},\"users\":{\"install\":true,\"status\":true},\"yform\":{\"install\":false,\"status\":false,\"plugins\":{\"docs\":{\"install\":false,\"status\":false},\"email\":{\"install\":false,\"status\":false},\"geo\":{\"install\":false,\"status\":false},\"manager\":{\"install\":false,\"status\":false},\"tools\":{\"install\":false,\"status\":false}}}}'),
  (382,'core','package-order','[\"be_style\",\"be_style\\/redaxo\",\"users\",\"backup\",\"install\",\"media_manager\",\"mediapool\",\"phpmailer\",\"project\",\"structure\",\"demo_fullpage\",\"metainfo\",\"structure\\/content\"]'),
  (539,'demo_fullpage','logo','\"\"'),
  (597,'demo_fullpage','theme','\"coffee\"'),
  (600,'demo_fullpage','navigationposition','\"right\"'),
  (601,'demo_fullpage','slidenavigationposition','\"bottom\"'),
  (603,'demo_fullpage','scrollingspeed','\"600\"'),
  (605,'demo_fullpage','showscrollbar','\"\"'),
  (606,'demo_fullpage','autoscrolling','\"1\"'),
  (607,'demo_fullpage','shownavigation','\"\"'),
  (608,'demo_fullpage','shownavigationtooltip','\"\"'),
  (609,'demo_fullpage','showslidenavigation','\"\"'),
  (610,'demo_fullpage','usesubcategories','\"\"');
